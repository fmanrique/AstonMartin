	...
	<div class="col-md-12">
		<div class="widget box">
			<div class="widget-header">
				<h4><i class="icon-edit"></i> New Activity Type</h4>
			</div>
			<div class="widget-content">
				<form class="form-horizontal row-border" method="post" id="form" action="<?php echo base_url() . "categories/save/"; ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<div class="row">
								<div class="col-md-4">
									<input type="text" name="color" class="form-control bs-colorpicker" value="#004F32" data-color-format="hex">
								</div>
							</div>
						</div>
					</div>
