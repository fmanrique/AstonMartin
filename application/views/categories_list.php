					...
					<?php foreach($data as $key => $category) {?>
						...
						<?php if (!empty($category['childs'])) : ?>
							...
							<tr>
								...
								<td class="align-center">
									<span class="btn-group">
										<a href="javascript:void()" onclick="javascript:delete_item('<?php echo base_url() . "categories/delete/" . $subcategory['id']; ?>')" title="Delete" class="bs-tooltip"><i class="icon-remove-sign"></i></a>
									</span>
								</td>
							</tr>
							<?php } ?>
