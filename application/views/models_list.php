			...
			<div class="widget-content no-padding">
				<table class="table datatable" id="audiences">
					...
					<?php foreach($data as $key => $model) {?>
							...
							<td class="align-center">
								<span class="btn-group">
									<a href="javascript:void()" onclick="javascript:delete_item('<?php echo base_url() . "models/delete/" . $model['id']; ?>')" title="Delete" class="bs-tooltip"><i class="icon-remove-sign"></i></a>
								</span>
							</td>
						</tr>
					<?php } ?>
