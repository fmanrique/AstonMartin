...
class audiences_model extends CI_Model {
	...
	public function get_all(){
		//Get only actives
		$query = $this->db->get_where('audiences', array('status_id' => 1));
	...
	public function get_by_id($id){
		//Get only actives
		$query = $this->db->get_where('audiences', array('id' => $id, 'status_id' => 1));
		return $query->result_array();
