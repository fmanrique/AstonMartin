...
class currencies extends CI_Controller {
	...
	public function index() {
		$vars['title'] = 'Currencies';
		$vars['content_view'] = '/currencies_list';
		$vars['option']  = "currencies";
		$vars['data'] = $this->currencies_model->get_all();
	...
	public function add() {
		$vars['title'] = 'Currencies';
		$vars['content_view'] = '/currencies_new';
		$vars['option']  = "currencies";
	...
	public function edit($id) {
		$vars['title'] = 'Currencies';
		$vars['content_view'] = '/currencies_edit';
		$vars['option']  = "currencies";
		$vars['data'] = $this->currencies_model->get_by_id($id);
